...
MJW Changes
*) enum value OVERFLOW now called OFLO due to the former now 
being, apparently, a reserved word (at least for gcc
*) rename2.h is no longer found in /include/python2.1 so 
rename2.h has been copied into this directory. Otherwise
set extradir to point to where it really is.
...
/* group states */
enum GState { UNKNOWN, FREE, ROOT, OFLO };
