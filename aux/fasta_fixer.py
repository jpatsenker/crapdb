...
def fix_file(input_file, output_file, lfil = None):
	"""
	Quick dirty fix to keep fasta reformat files into "fasta id \n sequence \n fasta id \n sequence \n ... etc" form used by CRAP
	Better solution by working with FastaReader and FastaWriter, but not every module uses FastaReader and FastaWriter, so this IS NECESSARY
	:param input_file:
	:param output_file:
	:param lfil:
	:return:
