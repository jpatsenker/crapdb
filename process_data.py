...
#sys.exit(0)
process_fastaCheck = subprocess.Popen('/bin/bash -c ". /opt/lsf/conf/profile.lsf; bsub -q short -K -W 1 -o ' + checked_file + ' -e tmp/errors.txt perl ' + fastaChecker + ' ' + input_file + ' 0"')
